  ...
  <section>
    ...
    <div class="mx-auto px-5 py-8 md:px-10 lg:py-12">
      ...
      <div class="mx-auto max-w-7xl">
        ...
        <!-- Team Items -->
        <div
          class="flex flex-wrap justify-center gap-3 md:justify-between md:gap-6 my-12"
        >
          <div
            ...
            >
              <div class="flex flex-col gap-1">
                ...
                <div class="flex flex-row gap-2 pt-14">
                  <a
                    href="#"
                    class="w-9 h-9 rounded-full bg-gray-600  hover:bg-[#ffffff] flex justify-center items-center"
                  >
                    <img
