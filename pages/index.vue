        ...
        <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-24">
            <div class="text-center">
                ...
                <div class="mt-10 sm:mt-20">
                    <a class="m-1 py-3 px-4 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-white dark:hover:bg-neutral-800"
                        href="#">
        ...
        <div class="grid lg:grid-cols-7 lg:gap-x-8 xl:gap-x-12 lg:items-center">
            <div class="lg:col-span-3">
                <h1 class="block text-3xl font-bold text-gray-800 sm:text-4xl md:text-5xl lg:text-6xl dark:text-white">
                    Build Better Products</h1>
                <p class="mt-3 text-lg text-gray-800 dark:text-neutral-400">Lorem ipsum dolor sit amet consectetur
                    adipisicing elit. Sequi explicabo error natus doloremque itaque provident commodi, iste fugiat
                    assumenda non amet accusamus, esse numquam facilis. Amet debitis ipsum unde consequatur? Lorem ipsum
                    dolor sit amet consectetur adipisicing elit. Ab vero inventore reprehenderit quam deserunt iure eius
                    temporibus corrupti iste? Consequatur cupiditate dolore iure eligendi maiores dolorem consectetur
                    eveniet sed totam?</p>
            </div>
            <!-- End Col -->
