<template>
  <div>
    ...
    >
      <div
        class="grid lg:grid-cols-3 gap-y-8 lg:gap-y-0 lg:gap-x-6 px-4 sm:px-6 lg:px-8 rounded-lg"
      >
        <!-- Content -->
        <div class="lg:col-span-2">
          <div class="py-6 lg:pe-8">
            ...
            >
              <ol
                class="inline-flex items-center space-x-1 md:space-x-3 overflow-clip"
              >
...
const imgSrc = useState("imgSrc", () => null);
const views = useState("views", () => null);
