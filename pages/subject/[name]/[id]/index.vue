<template>
    <div>
        ...
        <hr>
        <!-- Blog Article -->
        <div class="max-w-[85rem] px-4 sm:px-6 lg:px-8 mx-auto" id="app">
...
<div>
                            ...
                            <div class="flex justify-between px-4 items-center gap-x-1.5">
                                <!-- Button -->
        ...
        <div id="app" class="flex">
            ...
            <div class="w-3/12 bg-blue-200">
                <!-- Content for the smaller section (3/12) goes here -->
