            ...
            <div class="mt-12">
                ...
                <form @submit.prevent="submitForm">
                    <div class="grid gap-4 lg:gap-6">
                        <div>
                            <label for="about-us-name"
                                class="block mb-2 text-sm text-gray-700 font-medium">Name*</label>
                            <input :disabled="isSubmitting" type="text" v-model.trim="name" name="about-us-name"
                                id="about-us-name"
                            ...
                            <div class="col-span-1 flex flex-col gap-4 h-full">
                                ...
                                <div>
                                    <label for="about-us-name-of-case-with-citation"
                                        class="block mb-2 text-sm text-gray-700 font-medium">Name of the case with
                                        citation*</label>
                        ...
                        <div>
                            <label for="about-us-additional-comments"
                                class="block mb-2 text-sm text-gray-700 font-medium">Additional comments</label>
                            <textarea :disabled="isSubmitting" id="about-us-additional-comments"
                                v-model.trim="additionalComments" name="about-us-additional-comments" rows="4"
        ...
        <div class="w-80 md:max-w-xs bg-white border border-gray-200 rounded-xl shadow-lg" role="alert">
            <div class="flex p-4">
                <div class="flex-shrink-0">
                    <svg v-if="!isError" class="flex-shrink-0 size-4 text-teal-500 mt-0.5"
                        xmlns="http://www.w3.org/2000/svg" width="24" height="16" fill="currentColor"
                        viewBox="0 0 16 16">
                        <path
                    ...
                    <svg v-else xmlns="http://www.w3.org/2000/svg"
                        class="flex-shrink-0 size-4 text-red-500 mt-0.5 lucide" width="24" height="24"
...
export default {
    ...
    methods: {
        ...
        clearForm() {
            this.name = "";
            this.subject = "";
            this.whenDoYouNeedIt = "";
            this.nameOfCaseWithCitation = "";
