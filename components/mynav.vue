            ...
            <div class="relative md:flex md:items-center md:justify-between">
                <div class="flex items-center justify-between ">
                    ...
                    <!-- <div class="hidden sm:flex gap-3">
                        <div class="bg-slate-100 w-6 h-6"></div>
                        <div class="bg-slate-100 w-6 h-6"></div>
                        <div class="bg-slate-100 w-6 h-6"></div>
                        <div class="bg-slate-100 w-6 h-6"></div>
                    </div> -->
                ...
                <div id="navbar-collapse-with-animation "
                    ...
                    <div class="overflow-hidden overflow-y-auto max-h-[75vh] [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full flex justify-between items-center [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-neutral-700 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500">
                        <div class="hidden sm:flex gap-3">
                            <div class="bg-slate-100 w-6 h-6"></div>
                            <div class="bg-slate-100 w-6 h-6"></div>
                            <div class="bg-slate-100 w-6 h-6"></div>
                        ...
                        <div class="flex flex-col gap-x-0 mt-5 divide-y divide-dashed divide-gray-200 md:flex-row md:items-center md:justify-end md:gap-x-7 md:mt-0 md:ps-7 md:divide-y-0 md:divide-solid dark:divide-neutral-700">
                            <div class="flex gap-4">
                                ...
                                <div
                                        ...
                                        <div class="grid grid-cols-2 md:grid-cols-10">
                                            <div class="md:col-span-3">
                                                <div class="flex flex-col py-6 px-3 md:px-6">
                                                    <div class="space-y-4">
                                                        <span
                                                            class="mb-2 text-xs font-semibold uppercase text-gray-800 dark:text-neutral-200">About
                                                            us</span>

                                                        <a class="flex gap-x-4 text-gray-800 hover:text-blue-600 dark:text-neutral-200"
                                                            href="#">
                                            ...
                                            <div class="md:col-span-3">
                                                <div class="flex flex-col py-6 px-3 md:px-6">
                                                    <div class="space-y-4">
                                                        <span
                                                            class="mb-2 text-xs font-semibold uppercase text-gray-800 dark:text-neutral-200">Support</span>
                                                    ...
                                                    <div class="mt-7 space-y-4">
                                                        <span
                                                            class="mb-2 text-xs font-semibold uppercase text-gray-800 dark:text-neutral-200">Partners</span>
                                    ...
                                    <!-- items not in dorp down  -->
                                </div>
                            </div>
                        </div>
                        <div class="h-6 w-8 bg-slate-100">
