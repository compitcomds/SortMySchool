<template>
  <div id="search-modal"
    ...
    <div class="sm:max-w-lg sm:w-full m-3 sm:mx-auto">
      <div
        class="flex flex-col shadow-lg rounded-2xl w-[50vw] bg-white overflow-hidden pointer-events-auto absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 p-1 transition-all duration-300">
