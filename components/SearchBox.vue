          ...
          <div>
            ...
            >
              ...
              <nuxt-link
                :to="`/search/${search}`"
                @click="closeModal"
                class="min-w-fit flex-1 px-10 py-3 flex-shrink-0 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-md md:rounded-none md:rounded-e-md border border-transparent bg-sky-600 text-white hover:bg-sky-700 disabled:opacity-50 disabled:pointer-events-none"
              >
