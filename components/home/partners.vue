        ...
        <div class="mx-auto py-8 w-full">
            <div class="flex items-center justify-between">
                <h2 class="w-full font-semibold text-gray-700 mb-4 flex items-center gap-6">
                    <p class="text-2xl">Knowledge Partners</p>
                    <hr class="text-black bg-black h-[1.5px] w-[350px] mt-2 hidden lg:block" />
                </h2>
            </div>

            <!-- Swiper Container -->
            <swiper :space-between="20" :slides-per-view="1" :loop="true"
                :autoplay="{ delay: 4000, disableOnInteraction: false }" :modules="modules" :breakpoints="{
                    640: { slidesPerView: 1 },
                    768: { slidesPerView: 2 },
                    1024: { slidesPerView: 4 },
                }" class="swiper-container">
                <!-- Swiper Slide for each card -->
                <swiper-slide>
                    <div 
                        class="knowledge-partner-card mb-5 transition w-full max-w-[291px] duration-300 lg:mt-0 relative overflow-hidden text-left bg-slate-200 rounded-lg shadow-slate-700 hover:shadow-blue-200 shadow-md">
                        <div
                            ...
                            <div class="flex flex-col gap-1">
                                ...
                                <div class="flex flex-row gap-2 pt-6">
                                    <a href="https://www.instagram.com/legalstartupwala?igsh=Zmo3bDlhZzFzcDVk"
                            ...
                            <NuxtImg loading="lazy" width="180" height="290" decoding="async" data-nimg="1"
                                class="absolute left-[5.80rem] top-[9.08rem] lg:grayscale knowledge-partner-img"
                        ...
                        <div
                            ...
                            <div class="flex flex-col gap-1">
                                ...
                                <div class="flex flex-row z-10 gap-2 pt-6">
                                    ...
                                    <a href="https://www.linkedin.com/in/charvi-virmani-1ab1739b/"
                                        class="w-9 h-9 rounded-full bg-gray-600 hover:bg-[#0a66c2] flex justify-center items-center">
                                        <svg class="w-[1rem] h-[1rem] text-white" viewBox="0 0 13 12" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                    ...
                    <div 
                        ...
                        <div
                            ...
                            <div class="flex flex-col gap-1">
                                ...
                                <div class="flex flex-row gap-2 pt-6">
                                    <a href="https://www.linkedin.com/in/harshvardhanbhati?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
                                        class="w-9 h-9 rounded-full bg-gray-600 hover:bg-[#0a66c2] flex justify-center items-center">
                                        <svg class="w-[1rem] h-[1rem] text-white" viewBox="0 0 13 12" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                            ...
                            <NuxtImg alt="Harsh Vardhan Bhati | SortMyLawSchool Knowledge Partner" loading="lazy"
                                width="180" height="290" decoding="async" data-nimg="1"
                                class="knowledge-partner-img absolute left-[6.59rem] top-[8.00rem] lg:grayscale"
                        ...
                        <div
                            ...
                            <div class="flex flex-col gap-1">
                                ...
                                <ul class="text-black" style="list-style-type: disc">
                                    ...
                                    <li class="text-sm max-w-xs" style="line-height: 1.6">
                                        Law Clerk cum RA to HMJ, Sandeep Mehta, Supreme Court of
                                        India
                                    </li>
                                </ul>
                                <div class="flex flex-row gap-2 pt-2">
                                    <a href="https://www.linkedin.com/in/priyam-agarwal-12505b154?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
                                        class="w-9 h-9 rounded-full bg-gray-600 hover:bg-[#0a66c2] flex justify-center items-center">
                                        <svg class="w-[1rem] h-[1rem] text-white" viewBox="0 0 13 12" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                            ...
                            <NuxtImg alt="Priyam Agarwal | SortMyLawSchool Knowledge Partner" loading="lazy" width="180"
                                height="290" decoding="async" data-nimg="1"
                                class="absolute left-[6.30rem] top-[7.97rem] lg:grayscale knowledge-partner-img"
                    ...
                    <div
                        ...
                        <div
                                ...
                                <div class="flex flex-row gap-2 pt-14">
                                    <a href="#"
                                        ...
                                        <NuxtImg loading="lazy"
                                            ...
                                            alt="CA Shruti Sharma | SortMyLawSchool Chartered Accountant Logo" />
                                    </a>
                                </div>
                            </div>
                            ...
                            <NuxtImg alt="Shruti Sharma | SortMyLawSchool Knowledge Partner" loading="lazy" width="180"
                                height="290" decoding="async" data-nimg="1"
                                class="knowledge-partner-img absolute left-[6.60rem] top-[8.00rem] lg:grayscale rounded-4xl"
