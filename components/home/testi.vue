  ...
  <section class="w-full bg-white">
      ...
      <div class="mx-auto py-8 w-full">
          ...
          >
            ...
            >
              <div class="flex flex-col gap-1">
                <h2 class="text-xl font-semibold ">Neha Goyal</h2>
                <ul class="text-black" style="list-style-type: disc">
                  <li class="text-sm max-w-xs " style="line-height: 1.9">
                    Editor in Chief
                  </li>
              ...
              <div
                class="text-white text-2xl font-semibold leading-[40px]  -ml-4"
              >
                Neha<br />Goyal
              </div>
              <NuxtImg
                ...
                decoding="async"
                data-nimg="1"
                class="absolute left-[6.40rem] top-[4.6rem] scale-[115%]  lg:grayscale knowledge-partner-img"
...
defineOgImageComponent("NuxtSeo", {
  ...
  title:
      "SortMyLawSchool | India's Largest Database of Case Brief for Academia",
