<template>
  <div class="w-full py-16 px-2 md:px-5 lg:px-0 bg-white flex flex-col items-center">
    <!-- Stats Section -->
    <div class="flex items-center justify-center lg:gap-12 xl:gap-28 mb-20 w-full">
      <div data-aos="fade-right" data-aos-easing="linear" data-aos-duration="500"
        class="text-center pr-8 last:border-none">
        <p class="text-4xl xl:text-5xl font-semibold text-gray-800">{{ formatCount(studentCount) }}k</p>
        <p class="text-gray-600 text-lg">Views</p>
      </div>
      ...
      <div data-aos="fade-down" data-aos-easing="linear" data-aos-duration="500"
        ...
        <p class="text-4xl xl:text-5xl font-semibold text-gray-800">{{ formatCount(mentorCount) }}k</p>
        <p class="text-gray-600 text-lg">Subscribers</p>
      </div>
      <hr class="h-20 w-[0.5px] bg-slate-500">
      <div data-aos="fade-left" data-aos-easing="linear" data-aos-duration="500" class="text-center px-8">
        <p class="text-4xl xl:text-5xl font-semibold text-gray-800">{{ formatCount(courseCount) }}k</p>
        <p class="text-gray-600 text-lg">Likes</p>
      </div>
    </div>
    ...
    <div class="bg-[#fef1e1] rounded-lg shadow-lg h-60 py-6 px-5 w-full relative flex items-center justify-between">
      ...
      <div class="flex flex-col md:flex-row items-center justify-between w-full px- py-12">
        <p class="text-gray-800 font-semibold text-lg xl:text-3xl mb-4 md:mb-0 md:text-left text-center lg:w-1/3">
          ENTER YOUR EMAIL TO GET NEW COURSES <br>FOR <span
