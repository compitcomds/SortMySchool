    ...
    <div>
      <div v-if="propName">
        ...
        <div class="max-w-5xl mx-auto w-full p-5 bg-indigo-150 my-4 rounded-xl shadow-base-200 shadow-xl border-2">
          <template v-for="(blogs, letter) in propName" :key="letter">
            <!-- Heading -->
            <div class="flex gap-x-3">
              ...
              <div class="relative last:after:hidden after:absolute after:top-7 after:bottom-0 after:start-3.5 after:w-px after:-translate-x-[0.5px] after:bg-gray-200">
                <div class="relative z-10 size-7 flex justify-center items-center">
                  <span class="flex flex-shrink-0 justify-center items-center size-7 border border-gray-200 text-sm font-semibold uppercase text-gray-800 rounded-full">
                    {{ letter }}
                  </span>
                </div>
              </div>
        ...
        <ul class="flex flex-wrap justify-center items-center gap-5 p-5 max-w-5xl w-full mx-auto">
          <li class="w-full" v-for="i in 3">
            <div class="w-full flex flex-col group bg-white rounded-xl overflow-hidden transition min-w-80">
              ...
              <div v-for="i in 3" class="relative rounded-xl w-full h-fit min-h-16 mb-1 overflow-hidden bg-gray-300 skeleton">
