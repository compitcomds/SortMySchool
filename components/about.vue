      ...
      <div class="flex flex-col-reverse md:flex-row items-center justify-between gap-8">
        ...
        <div class="lg:w-1/2 w-full space-y-5">
          ...
          <p class="mt-4 text-gray-600 text-lg p-2">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed quis eros at
            lacus feugiat hendrerit sed ut tortor. Suspendisse et magna quis elit
            efficitur consequat. Mauris eleifend velit a pretium iaculis. Donec sagittis
          ...
          >
            <p class="text-2xl font-bold">Click Here</p>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
