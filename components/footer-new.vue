    ...
    <div class="container px-5 py-8 md:py-16 mx-auto">
      <div class="grid grid-cols-8 md:grid-cols-12 gap-x-8 gap-y-8">
        ...
        <div class="col-span-6 md:col-span-2">
          ...
          <nav class="list-none flex flex-col gap-y-2">
            <li>
              <a href="/privacy-and-terms-of-service" class="text-gray-600 hover:text-gray-900">Privacy Policy</a>
            </li>
        ...
        <div class="col-span-12 md:col-span-3">
          ...
          <div class="mt-5 mb-6 flex items-center gap-5 flex-wrap">
            ...
            <a
              href="https://www.linkedin.com/checkpoint/challenge/AgHidCLJdbOfIAAAAZIzSSx4wV9C3qfBoibaNHhlt1TvzoieY4sX6FGrl58jJbJ8cicB5RH8xYnIQvtZz4mtN8b-qYNgtw?ut=2gcSNcmAttjXs1">
              <button class="group transition-all duration-500 hover:-translate-y-2">
