<template>
    <header
        ...
        <hr>
        <nav class="w-full mx-auto px-6 py-2 md:px-6 lg:px-10 shadow-sm grid grid-cols-3 items-center justify-center"
            aria-label="Global">
            <div class="relative ">
            ...
            <div class="watsup-group flex items-center justify-end space-x-5">
                ...
                <button type="button"
                    class="whatsapp-icon p-2 inline-flex justify-center items-center rounded-full bg-green-500 text-white hover:bg-green-600"
                    aria-label="WhatsApp">
