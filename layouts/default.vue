        ...
        <nav class="w-full mx-auto px-6 py-2 md:px-6 lg:px-10 shadow-sm grid grid-cols-3" aria-label="Global">
            <div class="relative sm:flex sm:items-center">
                <div class="flex items-center">
                    <div class="sm:hidden">
                        <button type="button"
                            class="hs-collapse-toggle p-2 inline-flex justify-center items-center gap-x-2 rounded-lg  bg-white   text-black shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-transparent "
                    ...
                    <nuxt class="sm:hidden flex-none text-xl font-semibold text-black" href="#"><img
                ...
                <div id="navbar-slide-up-animation"
                    ...
                    <div class="flex flex-col gap-5 mt-5 sm:flex-row sm:items-center sm:justify-end sm:mt-0 sm:ps-5">
                        ...
                        <div
                            ...
                            <div
                                class="hs-dropdown-menu transition-[opacity,margin] sm:border duration-[0.1ms] sm:duration-[150ms] hs-dropdown-open:opacity-100 opacity-0 w-[800px] hidden z-10 sm:mt-3 top-full start-0 min-w-60 bg-white sm:shadow-md rounded-lg py-2 sm:px-2  sm:dark:border  before:absolute">
                                <div class="sm:grid sm:grid-cols-4">
                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        <nuxt
                                            class="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm   text-black hover:bg-gray-100 bg-gray-300 focus:ring-2 focus:ring-blue-500  "
                                            href="#">
                                            Explore More
                                        </nuxt>
                                    </div>
