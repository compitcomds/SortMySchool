<template>
    <!-- ========== HEADER ========== -->
    <header
        class="flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full bg-white text-sm py-3 md:py-0 dark:bg-neutral-900">
                    ...
                    <div
                        ...
                        <div
                            ...
                            <div
                                ...
                                <div
                                    class="hs-dropdown-menu transition-[opacity,margin] duration-[0.1ms] md:duration-[150ms] hs-dropdown-open:opacity-100 opacity-0 w-full hidden z-10 top-full start-0 min-w-60 bg-white md:shadow-2xl rounded-lg py-2 md:p-4 dark:bg-neutral-800 dark:divide-neutral-700 before:absolute before:-top-5 before:start-0 before:w-full before:h-5">
                                    <div class="md:grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                                        <div class="flex flex-col mx-1 md:mx-0">
                                            <a class="group flex gap-x-5 hover:bg-gray-100 rounded-lg p-4 dark:text-neutral-200 dark:hover:bg-neutral-500/10"
                                                href="#">
                                                <!-- <svg class="flex-shrink-0 size-5 mt-1"
                                                ...
                                                <div class="grow">
                                                    <p class="font-medium text-gray-800 dark:text-neutral-200">Support
                                                        Docs</p>
                                                    <p
                                            ...
                                            <a class="group flex gap-x-5 hover:bg-gray-100 rounded-lg p-4 dark:text-neutral-200 dark:hover:bg-neutral-500/10"
                                                ...
                                                <div class="grow">
                                                    <p class="font-medium text-gray-800 dark:text-neutral-200">API
                                                        Reference</p>
                                                    <p
                                                        class="text-sm text-gray-500 group-hover:text-gray-800 dark:text-neutral-500 dark:group-hover:text-neutral-200">
                                        ...
                                        <div class="flex flex-col mx-1 md:mx-0">
                                            <a class="group flex gap-x-5 hover:bg-gray-100 rounded-lg p-4 dark:text-neutral-200 dark:hover:bg-neutral-500/10"
                                                ...
                                                <div class="grow">
                                                    <p class="font-medium text-gray-800 dark:text-neutral-200">Help
                                                        Center</p>
                                                    <p
                                                        class="text-sm text-gray-500 group-hover:text-gray-800 dark:text-neutral-500 dark:group-hover:text-neutral-200">
                                            ...
                                            <a class="group flex gap-x-5 hover:bg-gray-100 rounded-lg p-4 dark:text-neutral-200 dark:hover:bg-neutral-500/10"
                                                ...
                                                <div class="grow">
                                                    <p class="font-medium text-gray-800 dark:text-neutral-200">Developer
                                                        Hub</p>
                                                    <p
                                                        class="text-sm text-gray-500 group-hover:text-gray-800 dark:text-neutral-500 dark:group-hover:text-neutral-200">
                                            ...
                                            <a class="group flex gap-x-5 hover:bg-gray-100 rounded-lg p-4 dark:text-neutral-200 dark:hover:bg-neutral-500/10"
                                                ...
                                                <div class="grow">
                                                    <p class="font-medium text-gray-800 dark:text-neutral-200">Community
                                                        Forum</p>
                                                    <p
                                                        class="text-sm text-gray-500 group-hover:text-gray-800 dark:text-neutral-500 dark:group-hover:text-neutral-200">
                                        ...
                                        <div class="flex flex-col pt-4 md:pt-0 mx-1 md:mx-0">
                                            <span
                                                class="text-sm font-semibold uppercase text-gray-800 dark:text-neutral-200">Customer
                                                stories</span>

                                            <!-- Link -->
                                            <a class="group mt-2 p-3 flex gap-x-5 items-center rounded-xl hover:bg-gray-100 dark:hover:bg-neutral-500/10"
                                                href="#">
