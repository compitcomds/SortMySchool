<template>
  ...
  >
    <div
      class="inline-flex gap-5 justify-between items-center sm:p-0 md:p-0 lg:py-6 lg:px-10"
    >
      <div class="h-auto w-36 hidden sm:block md:block">
        <img
          src="https://www.3forty.media/zosia/demo-5/wp-content/uploads/2022/09/zosia-logo.png"
          alt=""
          srcset=""
        />
      ...
      <div>
        <img
          src="https://www.3forty.media/zosia/demo-5/wp-content/uploads/2022/09/header-promo.png"
          alt=""
          srcset=""
        />
      </div>
    ...
    <hr />
    <nav
      class="w-full mx-auto px-6 py-2 md:px-6 lg:px-10 shadow-sm grid grid-cols-3"
      aria-label="Global"
    >
          ...
          <div class="sm:hidden">
            ...
            >
              ...
              >
                ...
                <nuxt-link
                  class="font-medium text-black hover:text-gray-400"
                  to=""
                  >About</nuxt-link
                >
              </div>
      ...
      <!-- <nuxtlink
        class="sm:hidden flex items-center text-xl font-semibold text-black"
        to="index"
        ><img
          src="https://www.3forty.media/zosia/demo-5/wp-content/uploads/2022/09/zosia-logo.png"
          alt=""
      ...
      <div class="relative">
        ...
        >
          <div
            class="flex flex-col gap-5 mt-8 sm:flex-row sm:items-center sm:justify-end sm:mt-0 sm:ps-5"
          >
            <nuxt class="font-medium text-blue-500" href="#" aria-current="page"
              >Home
            </nuxt>
            ...
            <nuxt-link class="font-medium text-black hover:text-gray-400" to=""
              >About</nuxt-link
            >
          </div>
        </div>
        ...
        <div class="modal w-screen" role="dialog">
          <div class="modal-box">
            <label
              ...
              for="my_modal_7"
              ><Span
                class="w-6 h-auto px-2 py-0 rounded-md pb-1 border hover:bg-slate-200 border-red-400 font-semibold"
                >x</Span
              ></label
            >
